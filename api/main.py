    ...
    for i in range(len(data)):
        if data[i]['id'] == 14:
            ...
            for j in range(len(data[i]['subcategories'])):
                it_skills[data[i]['subcategories'][j]['id']
                          ] = data[i]['subcategories'][j]['name']
            return it_skills
        ...
        for j in range(len(data[i]['subcategories'])):
            for k in range(len(data[i]['subcategories'][j]['skills'])):
                if 1401 <= data[i]['subcategories'][j]['id'] <= 1499:
                    skills_id_to_name[data[i]['subcategories'][j]['skills'][k]
                                      ['id']] = data[i]['subcategories'][j]['skills'][k]['name']
